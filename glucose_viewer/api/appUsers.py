...
def get_appuser(user_id: int, db: Session = Depends(get_db)):
...
def update_appuser(user_id: int, user: schemas.AppUserCreate, db: Session = Depends(get_db)):
...
def delete_appuser(user_id: int, db: Session = Depends(get_db)):
...
def get_appuser_clients(user_id: int, db: Session = Depends(get_db)):
